...
/* ============================ rv_system_lock_holder_multiple.h ===================================== //
...
//header guard begin
    #ifndef rv_system_SLASH_rv_system_lock_SLASH_rv_system_lock_holder_multiple_DOT_h
    #define rv_system_SLASH_rv_system_lock_SLASH_rv_system_lock_holder_multiple_DOT_h
...
/* ------------------- structure stubs --------------------------------------- */
    ...
    //handles ownership of mutex lock
        struct rv_system_lock_holder_multiple_s;
...
/* ------------------- structure definition ---------------------------------- */
    ...
    //handles ownership of one or more locks on a mutex
        #define rv_system_lock_holder_multiple_entry_max 20
        struct rv_system_lock_holder_multiple_s
        {
        //super
            struct rv_system_lock_holder_s  super;
        //entries
            struct rv_system_lock_entry_s   entries[ rv_system_lock_holder_multiple_entry_max ];
        };
...
/* ------------------- static function stubs --------------------------------- */
    ...
    //returns true when successful
        ...
        typedef bool (* rv_system_lock_holder_multiple_create_static_ptr)
        (
        //pointer to memory holding struct
            struct rv_system_lock_holder_multiple_s     *t,
        //size of memory pointed to (must be equal or bigger than size of struct)
    ...
    //rv_system_time_destroy_static() releases resources in struct in externally allocated memory
        ...
        typedef void (* rv_system_lock_holder_multiple_destroy_static_ptr)
        (
        //pointer to memory holding struct
            struct rv_system_lock_holder_multiple_s     *t
        );
    ...
    //rv_system_lock_holder_add() add mutex to holder collection
        ...
        typedef bool (* rv_system_lock_holder_multiple_add_ptr)
        (
        //pointer to struct
            struct rv_system_lock_holder_multiple_s     *t,
        //pointer to lock to add
    ...
    //rv_system_lock_holder_multiple_contains() returns true if collection contains that mutex
        ...
        typedef bool (* rv_system_lock_holder_multiple_contains_ptr)
        (
        //pointer to struct
            struct rv_system_lock_holder_multiple_s     *t,
        //pointer to lock to add
    ...
    //rv_system_lock_holder_is_locked() returns true if collection contains that mutex and its locked
        ...
        typedef bool (* rv_system_lock_holder_multiple_is_locked_ptr)
        (
        //pointer to struct
            struct rv_system_lock_holder_multiple_s     *t,
        //pointer to lock to add
    ...
    //rv_system_lock_holder_clear() clear all mutexes (will unlock them)
        ...
        typedef void (* rv_system_lock_holder_multiple_clear_ptr)
        (
        //pointer to struct
            struct rv_system_lock_holder_multiple_s     *t
        );
    ...
    //rv_system_lock_holder_lock() lock add mutexes
        ...
        typedef bool (* rv_system_lock_holder_multiple_lock_ptr)
        (
        //pointer to struct
            struct rv_system_lock_holder_multiple_s     *t,
        //wait forever if true
    ...
    //rv_system_lock_holder_unlock() unlock all mutexes
        ...
        typedef void (* rv_system_lock_holder_multiple_unlock_ptr)
        (
        //pointer to struct
            struct rv_system_lock_holder_multiple_s     *t
        );
...
/* -------- structures containing easy function pointers --------------------- */
    ...
    //contains time struct methods
        struct rv_system_lock_holder_multiple_ptr_s
        {
        //create static
            rv_system_lock_holder_multiple_create_static_ptr     create_static;
        //destroy static
            rv_system_lock_holder_multiple_destroy_static_ptr    destroy_static;
        //add
            rv_system_lock_holder_multiple_add_ptr               add;
        //contains
            rv_system_lock_holder_multiple_contains_ptr          contains;
        //is_locked
            rv_system_lock_holder_multiple_is_locked_ptr         is_locked;
        //clear
            rv_system_lock_holder_multiple_clear_ptr             clear;
        //lock
            rv_system_lock_holder_multiple_lock_ptr              lock;
        //unlock
            rv_system_lock_holder_multiple_unlock_ptr            unlock;
        };
