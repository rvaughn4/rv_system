...
/* ------------------- included headers --------------------------------------- */
    ...
    //rwl
        ...
        char *rv_system_object_type__object_writelock = "object_writelock";

/* ----------- virtual function/method stubs and typedefs -------------------- */

        struct rv_system_object_base_vtble_s rv_system_object_writelock_vtble =
        {
        /*.init=*/                  __rv_system_object_writelock_init,
        /*.deinit=*/                __rv_system_object_writelock_deinit,
        /*.gen_ref=*/               __rv_system_object_base_gen_ref,
        /*.gen_writelock=*/         __rv_system_object_base_gen_readlock,
        /*.gen_writelock=*/         __rv_system_object_base_gen_writelock,
        /*.get_type=*/              __rv_system_object_writelock_get_type,
        /*.get_type_name=*/         __rv_system_object_writelock_get_type_name,
        /*.get_all_type_names=*/    __rv_system_object_writelock_get_all_type_names,
        /*.get size=*/              __rv_system_object_writelock_get_size,
        /*.get_type_value=*/        __rv_system_object_writelock_get_type_value,
...
/* -- virtual method corresponding static function definitions --------------------- */
    ...
    //init function, returns true if successful
        ...
        //init
            do
            {
                if( !p_base->vtble->get_type( p_base, (void **)&po, rv_system_object_type__object_writelock ) )
                    continue;
                po->obj = 0;
            //return success
                return 1;
    ...
    //unlink object to this object
        bool __rv_system_object_writelock_unlink
        (
        //pointer to object base
            struct rv_system_object_base_s      *p_base,
        //pointer to object base to link
