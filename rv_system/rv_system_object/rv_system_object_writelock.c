...
/* ----------- virtual function/method stubs and typedefs -------------------- */
        ...
        /*.gen_ref=*/               __rv_system_object_writelock_gen_ref,
        /*.gen_writelock=*/         __rv_system_object_writelock_gen_readlock,
        /*.gen_writelock=*/         __rv_system_object_writelock_gen_writelock,
